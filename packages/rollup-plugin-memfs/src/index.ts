...
export const altfsPlugin = (fs: FS_API) => {
  ...
  return {
    ...
    async load(id: string) {
      // check Vue SFC parsing query that generated by `rollup-plugin-vue`
      if (isVueSFCParseQuery(id)) {
        // The case of parsed Vue SFC query, rollup-plugin-memfs does not read it from memfs.
        // because rollup-plugin-vue have Vue SFC blocks.
        return;
      }
